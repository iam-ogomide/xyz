...
const Pricing = () => {
    ...
    const packages = [
        {name:"Start", monthlyPrice: 19, yearlyPrice: 199, description: 'lo Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque facere repellendus excepturi', green :"/src/assets/green.png"},
        {name:"Advance", monthlyPrice: 39, yearlyPrice: 399, description: 'lo Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque facere repellendus excepturi', green :"/src/assets/green.png"},
        {name:"Premium", monthlyPrice: 59, yearlyPrice: 599, description: 'lo Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque facere repellendus excepturi', green :"/src/assets/green.png"},
    ]
  return (
    <div className='md:px-14 p-4 max-w-s mx-auto py-10' id='pricing'>
        <div className="text-center">
            <h2 className="md:text-5xl text-3xl font-extrabold text-primary mb-2">Here are all our plans</h2>
            <p className='text-tartiary md:w-1/3 mx-auto px-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque facere repellendus excepturi consequuntur illo ab?</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-20 md:w-11/12 mx-auto">
            {
                packages.map((pkg,index) => <div key={index} className='border py-10 md:px-6 px-4 rounded-lg shadow-3xl'>
                    ...
                    <ul className='mt-4 space-y-2 px-4'>
                        ...
                        <li className='flex gap-3 items-center'><img src={pkg.green} alt="" className='w-4 h-4'/>VPersonal advice from teachers</li>
                    </ul>
